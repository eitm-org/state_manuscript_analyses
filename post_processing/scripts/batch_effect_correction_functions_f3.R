...
data = data %>% filter(if_all(Median_Coverage, ~ . >= 20)) %>%
  ...
  filter(!grepl('EIBS-002GA|EIBS-002GB|EIBS-002GC|EIBS-002GD', EIBS))

global = read.csv("/home/xchen@okta-oci.eitm.org/projects/STATE_analyses/data/aggregate_snv_patient_global_f3.csv")
chrom = read.csv("/home/xchen@okta-oci.eitm.org/projects/STATE_analyses/data/aggregate_snv_patient_chrom_f3.csv")
mbps = read.csv("/home/xchen@okta-oci.eitm.org/projects/STATE_analyses/data/aggregate_snv_patient_Mbps_f3.csv")
...
# data = merged_qc_global
# keyword = 'count'
# batch = 'LSK'
# confounder = 'Median_Coverage'
# saveFile = F
...
write.csv(merged_qc_global_10Hr_adj, "/home/xchen@okta-oci.eitm.org/projects/STATE_analyses/data/global_batch_adj_f3.csv", row.names = FALSE) 
...
write.csv(merged_qc_chrom_10Hr_adj, "/home/xchen@okta-oci.eitm.org/projects/STATE_analyses/data/chrom_batch_adj_f3.csv", row.names = FALSE) 
...
write.csv(merged_qc_mbps_10Hr_adj, "/home/xchen@okta-oci.eitm.org/projects/STATE_analyses/data/mbps_batch_adj_f3.csv", row.names = FALSE) 
