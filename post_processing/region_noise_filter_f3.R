...
dir.create(file.path(flat_results_dir, 'STATE_vcfs_f3_region_filtered'), showWarnings = FALSE)
dir.create(file.path(flat_results_dir, 'STATE_vcfs_f3_region_filtered', 'full_genome'), showWarnings = FALSE)
...
write.csv(region_filtered_counts, 'region_noise_filtered_counts_f3.csv')
