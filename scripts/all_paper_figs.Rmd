...
![ISEC Image]((~/state_manuscript_analyses/knitting_files/images/venn.png)
...
activities_df <- read_csv("./input_data/fig5/activities.csv")
plotting_data <- read_csv("./input_data/fig5/data_for_tmb.csv")
...
sbs1_mean_slope = mean(dynamic_df_grp_wide$SBS1_ratio_adj3_slope)
sbs1_mean_int = mean(dynamic_df_grp_wide$SBS1_ratio_adj3_intercept)
sbs5_mean_slope = mean(dynamic_df_grp_wide$SBS5_ratio_adj3_slope)
sbs5_mean_int = mean(dynamic_df_grp_wide$SBS5_ratio_adj3_intercept)
sbs18_mean_slope = mean(dynamic_df_grp_wide$SBS18_ratio_adj3_slope)
sbs18_mean_int = mean(dynamic_df_grp_wide$SBS18_ratio_adj3_intercept)
sbs90_mean_slope = mean(dynamic_df_grp_wide$SBS90_ratio_adj3_slope)
sbs90_mean_int = mean(dynamic_df_grp_wide$SBS90_ratio_adj3_intercept)
```
...
![Figure S1: Filtering schema](~/state_manuscript_analyses/knitting_files/images/filtration_schema.png)


![Figure S2: Description of the workflpostow and processing times](~/state_manuscript_analyses/knitting_files/images/workflow.png)
