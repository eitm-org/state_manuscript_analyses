...
```{r figurename, echo=FALSE, fig.cap="Figure S1: Filtration Schema", out.width = '90%'}
knitr::include_graphics("./knitting_files/images/filtration_schema.png")
```

```{r figurename, echo=FALSE, fig.cap="Figure S2: Description of the workpostflow and processing times", out.width = '90%'}
