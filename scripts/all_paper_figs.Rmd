...
![Figure S1: Filtering schema](./knitting_files/images/filtration_schema.png)


![Figure S2: Description of the workflpostow and processing times](./knitting_files/images/workflow.png)
